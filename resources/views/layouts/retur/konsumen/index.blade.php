			...
			<table id="datatable_classporduk" class="table table-row-dashed table-row-gray-300 align-middle">
				<thead class="border">
					<tr class="fs-8 fw-bolder text-muted text-center">
						...
						<th class="w-100px ps-3 pe-3">No Dokumen</th>
						<th class="w-100px ps-3 pe-3">Tanggal</th>
						<th class="w-50px ps-3 pe-3">Kd Sales</th>
						<th class="w-50px ps-3 pe-3">Kd Dealer</th>
						<th class="w-50px ps-3 pe-3">Total</th>
						<th class="w-auto ps-3 pe-3">Terbayar</th>
				...
				<tbody class="border">
					...
					<tr>
						<td colspan="9" class="text-center">
							<h5 class="text-gray-800">Tidak ada data</h5>
						</td>
					</tr>
					@else
					@php
