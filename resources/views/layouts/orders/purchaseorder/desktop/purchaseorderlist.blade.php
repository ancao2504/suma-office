                ...
                <table class="table table-row-dashed table-row-gray-300">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                @if($data->on_faktur == 1)
                                <div class="badge badge-light-success badge-lg fs-8 fw-boldest mt-2">SUDAH DIPROSES</div>
                                @else
                                    @if($data->approve == 1)
                            ...
                            <td class="text-end">
                                <a href="{{ route('orders.purchase-order-form', trim($data->nomor_pof)) }}" class="btn btn-icon btn-bg-primary btn-sm">
