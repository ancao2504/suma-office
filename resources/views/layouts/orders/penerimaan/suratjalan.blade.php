        ...
        <div class="modal fade" id="suratjalanModal" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="staticBackdropLabel" aria-hidden="true" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <form id="suratjalanModalForm" name="searchTipeMotorForm" autofill="off" autocomplete="off">
                        ...
                        <div class="modal-body">
                            <div class="fv-row mb-5">
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="input_search" name="input_search" type="text" class="form-control" placeholder="Input Dealer">
                                    <button id="btn_search" name="btn_search" class="btn btn-primary">Cari</button>
                                </div>
                            </div>
                            <div id="SuratJalanModal">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover" id="tableSuratJalan">
                                        <thead>
                                            <tr>
                                                <th>Aksi</th>
