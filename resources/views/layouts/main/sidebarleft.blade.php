                ...
                @if (in_array(Session::get('app_user_role_id'), ['MD_H3_MGMT', 'MD_OL_ADMIN']))
                    ...
                    <div class="menu-item">
                        <a class="menu-link {{ Request::is('uploadfile/pricelist*') ? 'active' : '' }}"
                            ...
                            <span class="menu-title {{ Request::is('uploadfile/pricelist*') ? 'active' : '' }}">Excel Price List</span>
                        </a>
                    </div>
                    @endif
                    ...
                    <div class="menu-item">
                        <a class="menu-link {{ Request::is('uploadimage/motor*') ? 'active' : '' }}"
                            ...
                            <span class="menu-title {{ Request::is('uploadimage/motor*') ? 'active' : '' }}">Detail Motor</span>
                        </a>
                    </div>

                    @if (in_array(Session::get('app_user_role_id'), ['MD_H3_MGMT']))
                    <div class="menu-item">
                        <a class="menu-link {{ Request::is('uploadfile/vb*') ? 'active' : '' }}"
                            href="{{ url('/uploadfile/vb') }}">
                            <span class="menu-icon">
                                <span class="svg-icon svg-icon-muted svg-icon-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none">
                            ...
                            <span class="menu-title {{ Request::is('uploadfile/vb*') ? 'active' : '' }}">VB Update</span>
                        </a>
                    </div>
                    @endif
                @endif
