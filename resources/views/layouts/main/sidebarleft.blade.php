<div id="kt_aside" class="aside aside-light aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_mobile_toggle">
    ...
    <div class="aside-menu flex-column-fluid">
        <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0">
            <div class="menu menu-lg-rounded menu-column menu-state-bg menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true" data-kt-menu-expand="false">
                <div class="menu-item">
                ...
                @elseif (Session::get('app_user_role_id') == 'MD_OL_SPV')
                <div class="menu-item">
                    <div class="menu-content pt-8 pb-2">
                        <span class="menu-section text-muted text-uppercase fs-8 ls-1">DASHBOARD</span>
                    </div>
                ...
                <div class="menu-item">
                    <a class="menu-link {{ (Request::is('dashboard/*')) ? 'active' : '' }}" href="{{ route('dashboard.marketplace.marketplace') }}">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-muted svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                    <path d="M3 7.19995H10C10.6 7.19995 11 6.79995 11 6.19995V3.19995C11 2.59995 10.6 2.19995 10 2.19995H3C2.4 2.19995 2 2.59995 2 3.19995V6.19995C2 6.69995 2.4 7.19995 3 7.19995Z" fill="currentColor"/>
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ (Request::is('dashboard/*')) ? 'here hover show' : '' }}">
                    ...
                    <div class="menu-sub menu-sub-accordion {{ (Request::is('dashboard/management/*')) ? 'show' : '' }}" >
                        ...
                        <div class="menu-item">
                            <a class="menu-link {{ (Request::is('dashboard/marketplace')) ? 'active' : '' }}" href="{{ route('dashboard.marketplace.marketplace') }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                ...
                <div class="menu-item">
                    <a class="menu-link {{ (Request::is('gudang/packing/online*')) ? 'active' : '' }}" href="{{ url('/gudang/packing/online/form') }}">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-muted svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                    <path opacity="0.3" d="M3 13H10C10.6 13 11 13.4 11 14V21C11 21.6 10.6 22 10 22H3C2.4 22 2 21.6 2 21V14C2 13.4 2.4 13 3 13Z" fill="currentColor"/>
                        ...
                        <span class="menu-title {{ (Request::is('gudang/packing/online*')) ? 'active' : '' }}">Packing Online</span>
                    </a>
                </div>
                <div class="menu-item">
                    <a class="menu-link {{ (Request::is('claim/supplier*')) ? 'active' : '' }}" href="{{ url('/claim/supplier/form') }}">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-muted svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                    <path opacity="0.3" d="M3 13H10C10.6 13 11 13.4 11 14V21C11 21.6 10.6 22 10 22H3C2.4 22 2 21.6 2 21V14C2 13.4 2.4 13 3 13Z" fill="currentColor"/>
                        ...
                        <span class="menu-title {{ (Request::is('claim/supplier*')) ? 'active' : '' }}">Claim Supplier</span>
                    </a>
                </div>
                @endif
