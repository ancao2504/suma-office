...
<div class="row g-0 mt-2">
    <div class="card card-flush shadow">
        ...
        @if (in_array(Session::get('app_user_role_id'), ['MD_H3_MGMT']) && strtoupper(trim($device)) != 'MOBILE')
            <div class="card-footer d-flex justify-content-end mt-3">
                <div class="d-flex justify-content-end">
                    <form action="{{ route('setting.approvehargarugi.approve-harga-rugi-update') }}" method="post">
                        @csrf
