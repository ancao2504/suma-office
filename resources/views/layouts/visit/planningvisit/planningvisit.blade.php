...
@section('container')
<div class="row g-0">
    <form id="purchase_order" name="purchase_order" action="{{ route('visit.planning.daftar') }}" method="get" autocomplete="off">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_6244763d95a3a" style="">
                        ...
                        <div class="px-7 py-5">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <a href="{{ route('visit.planning.daftar') }}" class="btn btn-sm btn-danger" role="button">Reset Filter</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="modal fade bs-example-modal-xl" tabindex="-1" id="entryModalPlanningVisit">
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="planningVisitForm" name="planningVisitForm" autofill="off" autocomplete="off" method="POST" action="{{ route('visit.planning.simpan') }}">
                @csrf
        ...
        $('body').on('click', '#deletePlanVisit', function (event) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ route('visit.planning.hapus') }}",
                        method: "POST",
                        data: {
