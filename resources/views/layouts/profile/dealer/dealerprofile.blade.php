            ...
            <div class="d-flex flex-wrap flex-sm-nowrap mb-3">
                <div class="me-7 mb-4">
                    <div class="symbol symbol-100px symbol-lg-80px symbol-fixed position-relative">
                        @if ($status_limit == 'LIMIT_PIUTANG')
                        <div class="symbol symbol-40px me-2">
                            <div class="symbol-label fs-2 fw-bold bg-light-success text-success">{{ trim($kode_dealer) }}</div>
                        </div>
                        @elseif ($status_limit == 'LIMIT_SALES')
                        <div class="symbol symbol-40px me-2">
                            <div class="symbol-label fs-2 fw-bold bg-light-warning text-warning">{{ trim($kode_dealer) }}</div>
                        </div>
                        @else
                        <div class="symbol symbol-40px me-2">
                            <div class="symbol-label fs-2 fw-bold bg-light-danger text-danger">{{ trim($kode_dealer) }}</div>
                        </div>
                        @endif
                    </div>
                </div>
                    ...
                    <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                        <div class="d-flex flex-column">
                            <div class="d-flex align-items-center mb-2">
                                <span class="text-gray-900 fs-2 fw-bolder me-1">{{ $kode_dealer }}</span>
                                @if ($status_limit == 'LIMIT_PIUTANG')
            ...
            <form id="kt_account_profile_details_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate">
                <div class="card-body border-top p-9">
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8 fv-row fv-plugins-icon-container">
                            <input type="text" name="company" class="form-control form-control-lg form-control-solid" value="{{ $email }}" readonly>
                        </div>
                    </div>
                    <div class="separator my-10"></div>
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8 fv-row fv-plugins-icon-container">
                            <input type="text" name="company" class="form-control form-control-lg form-control-solid" value="{{ $status }}" readonly>
                        </div>
                    </div>
                    <div class="row mb-6">
                        <label class="col-lg-4 col-form-label fw-bold fs-6">Sts</label>
                        <div class="col-lg-8 fv-row fv-plugins-icon-container">
                            <input type="text" name="company" class="form-control form-control-lg form-control-solid" value="{{ $sts }}" readonly>
                        </div>
                    </div>
                    {{-- <div class="row mb-6">
