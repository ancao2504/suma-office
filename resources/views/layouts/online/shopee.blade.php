    ...
    <div class="card-header align-items-center border-0 mt-4 mb-4">
        ...
        <div class="card-toolbar">
            <div class="input-group input-group-solid">
                <input type="text" class="form-control" id="tgl_dokumen" name="tgl_dokumen" placeholder="Tanggal Dolumen">
...
<!-- Modal tambah diskon-->
{{-- <div class="modal fade" id="tambah_diskon" data-backdrop="static" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="tambah_diskonLabel" aria-hidden="true">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="no_dokumen" class="form-label required mt-1">No Dokumen</label>
                                <input type="text" class="form-control" id="no_dokumen" name="no_dokumen" placeholder="No Dokumen" value="{{ old('no_dokumen')??'' }}" disabled>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="tgl" class="form-label mt-1">Tanggal</label>
                                <input type="text" class="form-control bg-secondary" id="tgl" name="tgl" placeholder="Tanggal" value="{{ old('tgl') }}" disabled>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="awal" class="form-label required mt-1">Awal</label>
                                <select class="form-select" id="awal" name="awal" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="tujuan" class="form-label required mt-1">Tujuan</label>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="ket" class="form-label required mt-1">Keterangan</label>
                                <textarea class="form-control" id="ket" name="ket" placeholder="Keterangan" value="{{ old('ket')??'0' }}" required></textarea>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
...
{{-- card detail --}}
<div class="card border shadow" id="card-detail" style="max-width: 500px; max-height: 500px; z-index: 999; position: absolute;" hidden>
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title">Detail Pemindahan</h5>
            <button type="button" class="btn-close" onclick="document.getElementById('card-detail').hidden = true"></button>
        </div>
        <div class="modal-body">
                    ...
                    <table class="table table-sm table-striped">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-sm btn-primary disabled btn-update">Update</button>
                                </td>
                            </tr>
                            <tr>
                                <td>2</td>
