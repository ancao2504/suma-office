        ...
        <div class="card card-flush shadow">
            <div class="card-header align-items-center border-0 mt-4">
                <h3 class="card-title align-items-start flex-column">
                    ...
                    <span class="text-muted fw-bold fs-7">Form pemindahan antar lokasi tiktok</span>
                </h3>
...
<script>
    const url = {
        'daftar_pemindahan': "{{ route('online.pemindahan.tiktok.form.detail') }}",
        'update_per_part_number': "{{ route('online.pemindahan.tiktok.form.update.part-number') }}",
        'update_status_per_part_number': "{{ route('online.pemindahan.tiktok.form.update.status-part-number') }}",
        'update_per_dokumen': "{{ route('online.pemindahan.tiktok.form.update.dokumen') }}",
    }
    const data = {
        'nomor_dokumen': "{{ strtoupper(trim($data->nomor_dokumen)) }}",
    }
</script>
<script src="{{ asset('assets/js/suma/online/tiktok/pemindahan/form.js') }}?v={{ time() }}"></script>
@endpush
@endsection
