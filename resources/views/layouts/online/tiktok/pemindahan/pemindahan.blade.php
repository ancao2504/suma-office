    ...
    <div class="card card-flush shadow">
        <div class="card-header align-items-center border-0 mt-4 mb-4">
            <h3 class="card-title align-items-start flex-column">
                ...
                <span class="text-muted fw-bold fs-7">Daftar pemindahan antar lokasi tiktok</span>
                ...
                <table class="table table-row-dashed table-row-gray-300 align-middle">
                    ...
                    <tbody class="border">
                        ...
                        <tr>
                            ...
                            <td class="ps-3 pe-3" style="text-align:center;vertical-align:top;">
                                <a href="{{ route('online.pemindahan.tiktok.form.form', strtoupper(trim($data->nomor_dokumen))) }}" class="btn btn-icon btn-sm btn-primary" type="button">
...
<script src="{{ asset('assets/js/suma/online/tiktok/pemindahan/daftar.js') }}?v={{ time() }}"></script>
@endpush
@endsection
