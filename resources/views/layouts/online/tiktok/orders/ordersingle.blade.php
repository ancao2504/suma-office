    ...
    <div class="card card-flush shadow">
        <div class="card-header align-items-center border-0 mt-4 mb-4">
            <h3 class="card-title align-items-start flex-column">
                ...
                <span class="text-muted fw-bold fs-7">Cari data invoice marketplace tiktok</span>
            </h3>
...
<script>
    const url = {
        ...
        'proses_pickup': "{{ route('online.orders.tiktok.form.pickup') }}",
    }
</script>
<script src="{{ asset('assets/js/suma/online/tiktok/orders/daftar.js') }}?v={{ time() }}"></script>
<script src="{{ asset('assets/js/suma/online/tiktok/orders/single.js') }}?v={{ time() }}"></script>
@endpush
@endsection
