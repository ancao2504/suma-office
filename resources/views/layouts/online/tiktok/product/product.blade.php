    ...
    <div class="card card-flush shadow">
        <div class="card-header align-items-center border-0 mt-4">
            <h3 class="card-title align-items-start flex-column">
                <span class="fw-bolder mb-2 text-dark">Products Tiktok</span>
                <span class="text-muted fw-bold fs-7">Form update productID marketplace tiktok</span>
            </h3>
...
<script>
    const url = {
        'daftar_product_id': "{{ route('online.product.tiktok.daftar') }}",
        'cek_product_id': "{{ route('online.product.tiktok.cek') }}",
        'update_product_id': "{{ route('online.product.tiktok.update') }}",
    }
</script>
<script src="{{ asset('assets/js/suma/online/tiktok/products/form.js') }}?v={{ time() }}"></script>
@endpush
@endsection
