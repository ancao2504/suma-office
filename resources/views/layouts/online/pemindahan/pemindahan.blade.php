                ...
                <div class="card card-flush">
                    <div class="card-header align-items-center border-0 mt-4 mb-4">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="fw-bolder mb-2 text-dark">Pemindahan Antar MarketPlace</span>
                            <span class="text-muted fw-bold fs-7">Daftar pemindahan antar lokasi MarketPlace</span>
                                                    ...
                                                    <tr class="fs-6 fw-bold text-gray-700"
                                                        ...
                                                        <td class="ps-3 pe-3"
                                                            style="text-align:center;vertical-align:top;">
                                                                @if(strtoupper(trim($data->lokasi_awal)) == 'OL')
                                                        ...
                                                        <td class="ps-3 pe-3"
                                                            style="text-align:center;vertical-align:top;">
                                                                @if(strtoupper(trim($data->lokasi_tujuan)) == 'OL')
                                                        ...
                                                        <td class="ps-3 pe-3"
                                                            ...
                                                            @else
                                                                @if ($data->validasi == 1)
                                                                    <button
                                                                    class="btn btn-icon btn-sm btn-danger btn_update"
                                                                    data-focus="0">
                                                        ...
                                                        <td class="ps-3 pe-3"
                                                            style="text-align:center;vertical-align:top;">
                                                            <a href="{{ route('online.pemindahan.daftar-detail', base64_encode($page_detail_data)) }}"
...
@push('scripts')
    ...
    <script language="JavaScript"
        src="{{ asset('assets/js/suma/online/pemindahan/Pemindahan.js') }}?v={{ time() }}"></script>
@endpush
