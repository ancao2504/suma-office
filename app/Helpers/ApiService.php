...
class ApiService {
    ...
    public static function PembayaranFakturDaftar($year, $month, $kode_sales, $kode_dealer, $status_pembayaran, $nomor_faktur,
                                    $page, $user_id, $role_id, $companyid) {
        $credential = 'Basic '.base64_encode(config('constants.api_key.api_username').':'.config('constants.api_key.api_password'));
    ...
    public static function StockHarianProses($companyid, $role_id, $kode_class, $kode_produk, $kode_produk_level, $kode_sub, $frg,
                                            $kode_lokasi, $kode_rak, $option_stock_sedia, $nilai_stock_sedia) {
        $credential = 'Basic '.base64_encode(config('constants.api_key.api_username').':'.config('constants.api_key.api_password'));
