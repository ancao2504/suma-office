...
class PemindahanController extends Controller
{
    public function daftarPemindahan(Request $request) {
        ...
        if($statusApi == 1) {
            ...
            $responseApi = ServiceTokopedia::PemindahanDaftar($request->get('page'), $per_page,
    ...
    public function formPemindahan($nomor_dokumen, Request $request) {
        $responseApi = ServiceTokopedia::PemindahanForm($nomor_dokumen,
    ...
    public function formPemindahanDetail(Request $request) {
        $responseApi = ServiceTokopedia::PemindahanFormDetail($request->get('nomor_dokumen'),
                            strtoupper(trim($request->session()->get('app_user_company_id'))));
        $statusApi = json_decode($responseApi)->status;
    ...
    public function updateStockPerPartNumber(Request $request) {
        $responseApi = ServiceTokopedia::PemindahanUpdatePerPartNumber(strtoupper(trim($request->get('nomor_dokumen'))),
    ...
    public function updateStockPerNomorDokumen(Request $request) {
        $responseApi = ServiceTokopedia::PemindahanUpdatePerNomorDokumen(strtoupper(trim($request->get('nomor_dokumen'))),
                                strtoupper(trim($request->session()->get('app_user_company_id'))));
        $statusApi = json_decode($responseApi)->status;
        $messageApi = json_decode($responseApi)->message;
    ...
    public function updateStatusPerPartNumber(Request $request) {
        $responseApi = ServiceTokopedia::PemindahanUpdateStatusPerPartNumber(strtoupper(trim($request->get('nomor_dokumen'))),
                        trim($request->get('part_number')), strtoupper(trim($request->session()->get('app_user_company_id'))));
        return json_decode($responseApi, true);
    }
}
