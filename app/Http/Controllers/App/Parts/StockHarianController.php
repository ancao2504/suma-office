...
class StockHarianController extends Controller
{
    ...
    public function proses(Request $request) {
        ...
        switch ($request->input('action')) {
            case 'cetak':
                $responseApi = ApiService::StockHarianProses(strtoupper(trim($request->session()->get('app_user_company_id'))), strtoupper(trim($request->session()->get('app_user_role_id'))),
                ...
                return view ('reports.stockharian.stockharianreport', compact('data'), [
