...
class OptionController extends Controller
{
    ...
    public function optionDealerCompany(Request $request)
    {
        $responseApi = Service::optionDealer($request->get('search'), $request->get('page'), $request->get('per_page'),
    ...
    public static function fakturKlaim(Request $request){
        $responseApi = json_decode(Service::dataFakturKlaim($request));
        ...
        if ($statusApi == 1) {
            ...
            if($request->option == 'first'){
                ...
                $respon = view('layouts.option.optionFakturKlaim', [
                    'data' => $data,
                    'modal' => (object)[
                        'title' => 'List Faktur',
                        'size' => 'modal-lg',
                    ...
                    'cari' => (object)[
                        'title' => 'Cari No Faktur atau Part Number',
