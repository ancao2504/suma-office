...
class ApiSettingDiskonController extends Controller
{
        ...
        try {
            ...
            DB::transaction(function () use ($request) {
                DB::insert('exec SP_SettingDiscProduk_Simpan ?,?,?,?,?,?,?,?', [
                    ...
                    (float)$request->get('disc_normal'), (float)$request->get('disc_max'),
                    (float)$request->get('disc_plus_normal'), (float)$request->get('disc_plus_max'),
                    (float)$request->get('umur_faktur'), trim(strtoupper($request->get('user_id')))
                ]);
            });
