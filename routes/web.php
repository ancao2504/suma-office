...
use App\Upload\File\Motor\UploadImageController;
...
use App\Upload\File\VBUpdate\VBUpdateController;
        ...
        Route::name('Upload.')->group(function () {
            Route::name('file.')->group(function () {
                ...
                Route::controller(UploadImageController::class)->group(function () {
                    Route::get('/uploadimage/motor', 'form')->name('form-motor');
                    Route::post('/uploadimage/motor/simpanmaster', 'storeMaster')->name('simpan-motor-master');
                    Route::post('/uploadimage/motor/simpandetail', 'storeDetail')->name('simpan-motor-detail');
                    Route::post('/uploadimage/motor/simpandetailimage', 'storeDetailImage')->name('simpan-motor-detail-image');
                });
                Route::controller(VBUpdateController::class)->group(function () {
                    Route::get('/uploadfile/vb', 'form')->name('form-update-vb');
                    Route::post('/uploadfile/vb/simpan', 'store')->name('simpan-update-vb');
                    Route::post('/uploadfile/vb/hapus', 'destroy')->name('hapus-update-vb');
                });
            });
        });
    });
