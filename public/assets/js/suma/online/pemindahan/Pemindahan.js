...
$(document).ready(function() {
    ...
    $('.card-body').on('click', '.btn_update', function(event) {
        event.preventDefault();
        let no_dok = $(this).parents('tr').attr('data-no');
        Swal.fire({
            html: "Apakah anda yakin Update Stok Semua Part dari Nomor Dokumen : <b>" + $(this).parents('tr').attr('data-no') + "</b> ?",
            icon: "warning",
