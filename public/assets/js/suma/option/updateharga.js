...
// =====================================================================
function loadDataOptionUpdateHarga(page = 1, per_page = 10, search = '') {
    loading.block();
    $.ajax({
        url: base_url + '/option/updateharga' + "?search=" + search +
...
$(document).ready(function () {
    $(document).on('click', '#formOptionUpdateHarga #paginationOptionUpdateHarga .page-item a', function () {
        ...
        loadDataOptionUpdateHarga(page, per_page, search);
    });
    ...
    $('body').on('click', '#formOptionUpdateHarga #btnSearchOptionUpdateHarga', function (e) {
        ...
        loadDataOptionUpdateHarga(1, per_page, search);
    });
